...
<section class="registation-cards-section" id="registation-cards-section">
        ...
        <div class="reg-two-card-container">
            <div class="reg-card">
                <h2>Start your Journey</h2>
                <p>Participating in GOsP’23 is an opportunity to upgrade your Github profile. Enrich yourselves to
            ...
            <div class="reg-card">
                <h2>Lead the Pack</h2>
                <p>Mentors are the experts and take the lead of the open-source project team. They guide the fellow
                    participants at each stage in a road map of the project. They are the backbone of team and are
